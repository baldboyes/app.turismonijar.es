<template>
  ...
  >
    ...
    <div class="p-4 flex-1 flex flex-col justify-between min-w-0">
      <div>
        <!-- Date -->
        <span class="text-[10px] font-bold text-gray-600 uppercase tracking-wide block -mb-1">
          {{ formattedDate }}
        </span>

        <h3 class="font-extrabold text-primary text-base mb-1.5 line-clamp-2 group-hover:text-primary transition-colors leading-snug cursor-pointer">
          {{ article.title }}
        </h3>
